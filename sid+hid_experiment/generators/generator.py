...
from generators.data import Seq2SeqDataset, SeqDataset, SeqDatasetAllUser, Seq2SeqDatasetAllUser
...
class GeneratorAllUser(Generator):
    ...
    def make_trainloader(self):
        ...
        train_dataset = unzip_data(self.train, aug=self.args.aug, aug_num=self.args.aug_seq_len)
        self.train_dataset = SeqDataset(self.args, train_dataset, self.item_num, self.args.max_len, self.args.train_neg)
